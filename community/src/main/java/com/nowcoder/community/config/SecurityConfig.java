...
public class SecurityConfig implements CommunityConstant {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
                        ...
                        .authenticationEntryPoint(new AuthenticationEntryPoint() {
                            ...
                            public void commence(HttpServletRequest request, HttpServletResponse response, AuthenticationException authException) throws IOException, ServletException {
                                ...
                                if ("XMLHttpRequest".equals(xRequestedWith)) {
                                    ...
                                    writer.write(CommunityUtil.getJSONString(403, "Please log in first~"));
                                } else {
                        ...
                        .accessDeniedHandler(new AccessDeniedHandler() {
                            ...
                            public void handle(HttpServletRequest request, HttpServletResponse response, AccessDeniedException accessDeniedException) throws IOException, ServletException {
                                ...
                                if ("XMLHttpRequest".equals(xRequestedWith)) {
                                    response.setContentType("application/plain;charset=utf-8");
                                    PrintWriter writer = response.getWriter();
                                    writer.write(CommunityUtil.getJSONString(403, "Sorry, you do not have permission to access this page!"));
                                } else {
        ...
        // 跟 执行流程有关，反正这样写了，就能保持我们之前输入/logout就退出了
        http.logout((logout) ->
